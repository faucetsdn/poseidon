...
def test_parse_header():
    ...
    ret_dict = parse_header("2016-06-10 13:10:38.611239 IP 10.80.210.10.53 > 10.48.81.28.52852: 2816 4/0/0 CNAME registry-origin.docker.io., A 52.72.134.131, A 54.236.140.140, A 52.22.123.154 (116)")
    assert ret_dict['src_ip'] == "10.80.210.10"
    assert ret_dict['src_port'] == "53"
    assert ret_dict['dest_ip'] == "10.48.81.28"
    assert ret_dict['dest_port'] == "52852"
    ...
    ret_dict = parse_header("2016-06-10 13:10:53.740027 IP 10.80.210.10.53 > 10.48.81.28.50135: 9846 2/0/0 AAAA 2600:1408:10:195::2374, AAAA 2600:1408:10:193::2374 (99)")
    assert ret_dict['src_ip'] == "10.80.210.10"
    assert ret_dict['src_port'] == "53"
    assert ret_dict['dest_ip'] == "10.48.81.28"
    assert ret_dict['dest_port'] == "50135"
    assert ret_dict['length'] == 99
    assert "2600:1408:10:195::2374" in ret_dict['dns_resolved']
    assert "2600:1408:10:193::2374" in ret_dict['dns_resolved']
