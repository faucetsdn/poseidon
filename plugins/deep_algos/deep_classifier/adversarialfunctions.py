...
class Adversary(object):
    ...
    def dstIpSwapOut(self, dictOcoms, listOuniqIPs):
        ...
        sourceMAC = self.hexSessionList[0][:12]
    ...
    def noisyPacketMaker(self, maxPackets, packetTimeSteps, percentNoisy=0.2):
        ...
        # preserve mac, ip, and port by using only xrange(24,52)
        noisiness = int(len(xrange(24, 52)) * percentNoisy)
        ...
        for num in mutationIndex:
            ...
            if num == 0:
                ...
                noisyPacket = noisyPacket[:num] + \
                    randomReplacement + noisyPacket[num + 1:]
