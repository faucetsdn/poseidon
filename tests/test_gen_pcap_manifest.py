...
def test_gen_pcap_manifest():
    ...
    gen_pcap_manifest = os.path.sep.join((test_dir, '..', 'bin', 'gen_pcap_manifest.py'))
    ...
    with tempfile.TemporaryDirectory() as tempdir:
        ...
        with gzip.open(csv_file, 'r') as csv_out:
            all_csv_out = [line.decode('utf-8') for line in csv_out.readlines()]
            assert all_csv_out == ['eth,ip,pcap\r\n', '00:00:00:00:00:00,127.0.0.1,%s\r\n' % pcap_file]
