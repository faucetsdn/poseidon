...
def test_decode_endpoints():
    ...
    role_hashes = {
        '6b33db53faf33c77d694ecab2e3fefadc7dacc70': {'mac': '40:61:86:9a:f1:f5', 'pcap_labels': 'foo', 'top_confidence': 1.0, 'state': 'operating', 'top_role': 'Administrator workstation', 'second_role': 'GPU laptop', 'second_confidence': 0.0006269307506632729, 'third_role': 'Developer workstation', 'third_confidence': 0.000399485844886532}}
