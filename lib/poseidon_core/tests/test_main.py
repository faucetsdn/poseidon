...
def test_format_rabbit_message():
    ...
    data = {
        ...
        "data": {
            ...
            "results": {"tool": "p0f", "version": "0.11.17"},
        },
    }
    message = ("poseidon.algos.decider", data)
    retval, msg_valid = sdne.format_rabbit_message(message, faucet_event, remove_list)
    assert not retval
    assert msg_valid
        ...
        "data": {
            "6b33db53faf33c77d694ecab2e3fefadc7dacc70": {
                ...
                "classification": {
                    ...
                    "confidences": [
                        0.9955250173194201,
                        0.004474982679786006,
                        7.939512151303659e-13,
                    ],
                },
                "timestamp": 1608179739.839953,
                "source_ip": "208.50.77.134",
                "source_mac": "00:1a:8c:15:f9:80",
            },
            "pcap": "trace_foo.pcap",
        },
...
def test_rabbit_callback():
    ...
    rabbit_callback(mock_channel, mock_method, "properties", '{"body": 0}', mock_queue)
        ...
        def __init__(self):
            ...
            endpoint.metadata = {
                "mac_addresses": {
                    "00:00:00:00:00:00": {
                        "classification": {
                            "labels": ["developer workstation", "foo", "bar"],
                            "confidences": [0.8, 0.2, 0.0],
                        }
                    }
                },
                "ipv4_addresses": {"12.12.12.12": {"os": "windows"}},
...
def test_show_endpoints():
    ...
    endpoint.metadata = {
        "mac_addresses": {
            "00:00:00:00:00:00": {
                "classification": {"labels": ["developer workstation"]}
            }
        },
